    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 65, "an American country singer, songwriter, record producer and actor. ", "Lyle Lovett" },
                    { 2, 69, "an American country and bluegrass musician. In addition to singing, he plays guitar, fiddle, mandolin, banjo, bouzouki and mandocello. ", "Tim O'Brien" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Step Inside This House", 1, 280, "Step Inside This House" },
                    { 2, "Real Time", 2, 253, "Walk Beside Me" }
                });
